...
public class RouteSuggestionsConfigurator implements RouteConfigurator {
  ...
  public void configureRoutes(Vertx vertx, Router router, JsonObject config) {
    ...
    // Internal routes
    router.post(Constants.Route.API_INTERNAL_TEACHER_SUGGESTION_ADD)
        .handler(this::addTeacherSuggestion);
    router.put(Constants.Route.API_INTERNAL_SUGGESTIONS_ACCEPTANCE)
        .handler(this::userSuggestionAcceptance);
    router.post(Constants.Route.API_INTERNAL_SYSTEM_SUGGESTIONS_ADD)
        .handler(this::addSystemSuggestion);
  }
